...
class VideoRecorder:
    def __init__(
        ...
        # Set save directory from root_dir or leave it None if root_dir is not provided
        self.save_dir: tp.Optional[Path] = PROJECT_DIR / "exp_local" / "EXP" / "saved_training" / "test_video"
    ...
    def save(self, file_name: str) -> None:
        if self.save_dir is None or not self.frames:
            return
        path = self.save_dir / file_name
        print(f"Saving video {file_name} at: {path}")

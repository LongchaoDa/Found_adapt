...
# flags.DEFINE_string('method', 'icm', '')
flags.DEFINE_string('method', 'rnd', '')
flags.DEFINE_string('save_path', '/home/local/ASURITE/longchao/Desktop/project/sim2realFoun/Sim2Real/url_verify/url_benchmark/exp_local/2024.12.17/034327_rnd/verify', '')
...
# /home/local/ASURITE/longchao/Desktop/project/Sim2RealFoundation/HILP/datasets/walker/rnd/datasets/walker/rnd/replay.pt
# python convert.py --save_path=/home/local/ASURITE/longchao/Desktop/project/Sim2RealFoundation/HILP/datasets/verify --env=walker --task=run --method=rnd --num_episodes=5000 --use_pixels=0